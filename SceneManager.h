...
public:
	...
	// add in load for textures
	void MakeCup(float xPos, float yPos, float zPos);
	void MakePlate(float xPos, float yPos, float zPos);
	void MakeSaucer(float xPos, float yPos, float zPos);
	void MakeBowl(float xPos, float yPos, float zPos);
	void MakeSpoon(float xPos, float yPos, float zPos);
	void MakeChopSticksFront(float xPos, float yPos, float zPos);
	void MakeChopsticksBack(float xPos, float yPos, float zPos);
	void MakeTable();
	void LoadTextures();
